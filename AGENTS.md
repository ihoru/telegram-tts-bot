...
Never commit tokens, downloaded model files, generated audio, user text, or logs that
contain message content. Tests use fakes by default; run real-model and container tests
only through their documented markers or CI jobs.
